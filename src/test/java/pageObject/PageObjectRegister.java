...
public class PageObjectRegister {
    ...
    void logInUser(String email, String password) {                                                                     //Функция для выхода из учетной записи пользователя
    ...
    void formBillingAddress (String name, String lastName, String email, String countryId,String city,
